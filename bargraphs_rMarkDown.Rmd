...
dept_bargraph = ggplot(data = dept, aes (x = Department, y = count)) +
                ...
                theme(plot.title = element_text(face = "bold", hjust = 0.5, 
                      ...
                      axis.text = element_text(face = 12, size = 10,
                                               colour = "brown"),
...
gender_age_bargraph = ggplot(data = tab1, aes(x = age_groups, 
                      ...
                      labs(title = "Gender Distribution per Age group", 
                           caption = "FSDT 2017; Fig 1.1",
                           x = "Age_groups", 
                           y = "Count")
gender_age_bargraph 
```
<b>
Gender distribution on money from Savings Interest and Investments.
<b>
```{r}
...
educ_data = data %>%
  ...
  mutate(educ_level = if_else(Education_Level == 1, "No formal education",
                      ...
                      if_else(Education_Level == 4, "Post primary technical
                              training",
                      if_else(Education_Level == 5, "Some secondary",
                      if_else(Education_Level == 6, "University or other
...
educ_bargraph = ggplot(data = educ_data, 
                       aes(x = reorder(educ_level,educ_count), 
                           y = educ_count))+
