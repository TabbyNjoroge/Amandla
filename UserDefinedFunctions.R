...
##1. Write a function that takes in a number, and multiplies it by 100
...
##2. Write a function that takes in member's names, and passes a greeting
## e.g Goodafternoon Ann, welcome to the afternoon session.

##Goodafternoon Ann, welcome to the afternoon session.
##Goodafternoon Shel, welcome to the afternoon session.
##Goodafternoon Caren, welcome to the afternoon session.

majina <- c("Shel", "Ann", "Eve", "Tabby", "Caren", "Hannah", "Mary", "Nangira")

y <- paste0("Goodafternoon ", majina[6]," welcome to the afternoon session.")

## Write the function

greeter <- function(jina){
  y <- paste0("Goodafternoon ", jina," welcome to the afternoon session.")
return(y)
}

## Implementing/Calling the function
dad <- greeter("Dad")

##3. Write a function that displays the following message:
...
##5. Write a function that generates frequency tables and graphs for
##each of the categorical variables in the wafanyikazi dataset.
